...
%=====================================================================
%=====================================================================
% NOTA: TRB 2027 reemplaza el abstract tradicional por uno estructurado.
% Va en página aparte, inmediatamente después de la portada, sin nada más
% en esa página. Máx. 300 palabras. Revisá la plantilla LaTeX oficial de
% TRB por si define un entorno/macro propio para esto en vez de \textbf.
%=====================================================================
\begin{abstract}
...
is trained once offline on simulated healthy vibration signals and
...
(CWRU) bearing benchmark \cite{smith2015}. The asset-specific reference methods are trained and
calibrated using the complete healthy dataset of each condition. In contrast, the proposed method
